...
const FunctionPageScrollButton: React.FC<PageScrollButtonProps> = ({
  ...
  return (
    <button
      onClick={onClick}
      className="bg-[#0D0300] ring-1 ring-[#190600] transition-all hover:bg-[#190600] hover:ring-[#260900] flex flex-row gap-2 items-center justify-center lg:justify-start w-auto h-auto rounded-full px-2 py-2"
    >
