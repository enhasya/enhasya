...
const LandingProfile = () => {
  ...
  return (
    <div className="relative flex flex-col w-full h-auto items-start lg:items-center justify-center px-8 pt-0 pb-8 lg:px-32 lg:pt-0 lg:pb-32">
      <div className="bg-[#0C0C0C] ring-1 ring-[#181818] flex flex-col lg:flex-row w-full lg:w-[50%] h-auto items-start justify-center gap-0 lg:gap-16 rounded-lg p-8 lg:p-16">
